...
const decadeRemainder = (birthYear - 1900) % 10;
const decades = ((birthYear - 1900) - decadeRemainder)/10;
...
function math(firstNumber, secondNumber, opperation){
...
let myStrig = madlib(myWord1, myWord2, myWord3, myWord4);
